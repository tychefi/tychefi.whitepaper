...
- 创始团队：`99万枚`，市值每增长`$10万USDT`，则解锁`9900枚TWGT`给团队；
- 基金会：`1000万枚`, 全部严格用于市值管理，战略合作和生态建设促进；
- 社区用户质押挖矿：`1000万枚`，每100USDT投入`天池#5`资金即可挖得`1`枚`TWGT`，其中`0.9`枚同步锁仓在池内，`0.1`枚进入用户钱包。
...
- 天赐金融平台承诺每年拿出净利润部分的`10%`用来回购销毁`$TWGT`，直到最后总量通缩到`100万枚`。
